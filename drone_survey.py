...
"""
surveypath containes two typles in the form of [i,j,k] and [i',j',k'] wich are the coordinates (integer indices) for current state and the next state
x,y,z are the WorldWidth, WorldHeight and, WorldAltitude

Scale_x is the length of each state in airsim coordinate system. so, scale_x/2 is the centerpoint of eavh sate
"""
def start(survey_path,x,y,z,z_min=-30,z_max=-60,velocity=10,quad=31):
